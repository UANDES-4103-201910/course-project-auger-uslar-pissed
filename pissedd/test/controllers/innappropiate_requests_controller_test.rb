...
class InnappropiateRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create innappropiate_request" do
    assert_difference('InnappropiateRequest.count') do
      post innappropiate_requests_url, params: { innappropiate_request: { date: @innappropiate_request.date, justification: @innappropiate_request.justification, post_id: @innappropiate_request.post_id, user_id: @innappropiate_request.user_id } }
    end
  ...
  test "should update innappropiate_request" do
    patch innappropiate_request_url(@innappropiate_request), params: { innappropiate_request: { date: @innappropiate_request.date, justification: @innappropiate_request.justification, post_id: @innappropiate_request.post_id, user_id: @innappropiate_request.user_id } }
